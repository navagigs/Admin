            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li><a href="<?php echo base_url();?>admin"><i class="fa fa-dashboard fa-fw"></i> Beranda</a></li>
                        <li><a href="<?php echo base_url();?>admin/mahasiswa"><i class="fa fa-user fa-fw"></i> Data Mahasiswa</a></li>
                        <li><a href="<?php echo base_url();?>admin/prodi"><i class="fa fa-user fa-fw"></i> Data Prodi</a></li>
                        <li><a href="<?php echo base_url();?>admin/kelas"><i class="fa fa-user fa-fw"></i> Data Kelas</a></li>
                        <li><a href="<?php echo base_url();?>admin/ukm"><i class="fa fa-user fa-fw"></i> Data UKM</a></li>
                        <li><a href="<?php echo base_url();?>admin/pengelola"><i class="fa fa-user fa-fw"></i> Data Pengelola</a></li>
                        <li><a href="<?php echo base_url();?>admin/pendaftaran"><i class="fa fa-user fa-fw"></i> Data Pendaftaran</a></li>
