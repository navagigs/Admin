		...
		if($this->session->userdata('logged_in') == TRUE){
			...
			$data['action']				= (empty($filter1))?'view':$filter1;
                if ($data['action'] == 'view'){
                    ...
                    $data['mhs_kelas']		= ($this->input->post('mhs_kelas'))?$this->input->post('mhs_kelas'):'';
                    $data['mhs_prodi']		= ($this->input->post('mhs_prodi'))?$this->input->post('mhs_prodi'):'';
                    ...
                    $insert['mhs_kelas'] = validasi_sql($data['mhs_kelas']);
                    $insert['mhs_prodi'] = validasi_sql($data['mhs_prodi']);
				...
				$mahasiswa 						= $this->INT->get_mahasiswa('*', $where_mahasiswa);
                 ...
                 $data['mhs_kelas']			= ($this->input->post('mhs_kelas'))?$this->input->post('mhs_kelas'):$mahasiswa->mhs_prodi;
                 $data['mhs_prodi']			= ($this->input->post('mhs_prodi'))?$this->input->post('mhs_prodi'):$mahasiswa->mhs_prodi;
                ...
                if ($simpan){
                    ...
                    $edit['mhs_kelas']	= validasi_sql($data['mhs_kelas']);
                    $edit['mhs_prodi']	= validasi_sql($data['mhs_prodi']);
                    $edit['mhs_tahun_masuk']	= validasi_sql($data['mhs_tahun_masuk']);
                    $edit['mhs_foto']	= validasi_sql($data['mhs_foto']);
		...
		if($this->session->userdata('logged_in') == TRUE){
			...
			$data['action']				= (empty($filter1))?'view':$filter1;
                if ($data['action'] == 'view'){
                    ...
                    $insert['pengelola_password'] = validasi_sql($data['pengelola_password']);
                    $insert['ukm_id'] = validasi_sql($data['ukm_id']);
                ...
                if ($simpan){
                    ...
                    $edit['pengelola_password']	= validasi_sql($data['pengelola_password']);
